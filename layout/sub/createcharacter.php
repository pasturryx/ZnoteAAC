...
<script>
    function checkCharacterName() {
        ...
        if (name.length === 0) {
            nameError.innerHTML = '<img src="layout/img/nok.gif" alt="Error"> <b>Name is required.</b>';
            return;
        }
        ...
        .then(data => {
            ...
            if (data.success) {
                nameSuccess.innerHTML = '<img src="layout/img/ok.gif" alt="Success"> <b>' + data.message + '</b>';
            } else {
                nameError.innerHTML = '<img src="layout/img/nok.gif" alt="Error"> <b>' + data.message + '</b>';
            }
        })
        .catch(error => {
            console.error('Error:', error);
            nameError.innerHTML = '<img src="layout/img/nok.gif" alt="Error"> <b>Error validating name.</b>';
        });
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (characterName) {
            characterName.addEventListener('input', checkCharacterName);
        }
    });
</script>
<style>
