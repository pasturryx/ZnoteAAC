...
<!-- <div class="TableContainer" style="margin-top: 1cm; margin-bottom: 1cm;"> -->
	...
	<!-- <div class="TableContainer" style="margin-top: 1cm;"> -->
			   <!-- <div class="TableContainer"> -->
			   	<div class="TableContainer highlight" style="margin-top: 1cm; ">
    <table class="hoverTable">
		...
		<!-- <tr><th colspan="3">Character Information</th></tr> -->
				...
				<!-- Player country and name -->
				<!-- <tr class="highlight"> -->
				<tr><tr class="highlight"><td width="25%"><strong>Name:</strong></td><td><?php echo $profile_data['name']; ?>
			<?php 
if ($config['country_flags']['highscores'])
{ 
    echo '<img src="' . $config['country_flags']['server'] . '/' . $account_data['flag'] . '.png">'; 
}
?>
				</td>
            ...
            echo '
                <div class="outfit">
                    <img src="' . $config['show_outfits']['imageServer'] . '?id=' . $profile_data['looktype'] .
(isset($profile_data['lookaddons']) ? '&addons=' . $profile_data['lookaddons'] : '') .
'&head=' . (isset($profile_data['lookhead']) ? $profile_data['lookhead'] : '') .
'&body=' . (isset($profile_data['lookbody']) ? $profile_data['lookbody'] : '') .
'&legs=' . (isset($profile_data['looklegs']) ? $profile_data['looklegs'] : '') .
'&feet=' . (isset($profile_data['lookfeet']) ? $profile_data['lookfeet'] : '') . '" alt="img">
            ...
            ?>
				...
				<!-- Player Profession: -->
				<!-- <tr class="highlight"> -->
				<tr class="highlight"><td><strong>Profession:</strong></td><td><?php echo vocation_id_to_name($profile_data['vocation']); ?></td></tr>
				...
				<tr class="highlight"><td><strong>Status:</strong></td><td colspan="2"><?php
				if ($config['TFSVersion'] == 'TFS_10') 
				{
				...
				<!-- Player created -->
				<!-- <tr class="highlight"> -->
				<tr class="highlight"><td><strong>Created:</strong></td><td colspan="2"><?php echo getClock($profile_znote_data['created'], true); ?></td></tr>
	...
	<!-- </form> -->
        ...
        <div class="CaptionContainer">
            <div class="CaptionInnerContainer">
                ...
                <span class="CaptionBorderTop" style="background-image:url(layout/tibia_img/table-headline-border.gif);"></span>
                <span class="CaptionVerticalLeft" style="background-image:url(layout/tibia_img/box-frame-vertical.gif);"></span>
                    <div class="Text">Last Experience</div>
                <span class="CaptionVerticalRight" style="background-image:url(layout/tibia_img/box-frame-vertical.gif);"></span>
                <span class="CaptionBorderBottom" style="background-image:url(layout/tibia_img/table-headline-border.gif);"></span>
                <span class="CaptionEdgeLeftBottom" style="background-image:url(layout/tibia_img/box-frame-edge.gif);"></span>
                <span class="CaptionEdgeRightBottom" style="background-image:url(layout/tibia_img/box-frame-edge.gif);"></span>
...
<!-- </form> -->
        ...
        <div class="CaptionContainer">
            <div class="CaptionInnerContainer">
                ...
                <span class="CaptionBorderTop" style="background-image:url(layout/tibia_img/table-headline-border.gif);"></span>
                <span class="CaptionVerticalLeft" style="background-image:url(layout/tibia_img/box-frame-vertical.gif);"></span>
                    <div class="Text">Other visible characters on this account</div>
                <span class="CaptionVerticalRight" style="background-image:url(layout/tibia_img/box-frame-vertical.gif);"></span>
                <span class="CaptionBorderBottom" style="background-image:url(layout/tibia_img/table-headline-border.gif);"></span>
                <span class="CaptionEdgeLeftBottom" style="background-image:url(layout/tibia_img/box-frame-edge.gif);"></span>
                <span class="CaptionEdgeRightBottom" style="background-image:url(layout/tibia_img/box-frame-edge.gif);"></span>
                                    ...
                                    <div class="TableContentAndRightShadow" style="background-image:url(layout/tibia_img/table-shadow-rm.gif);">
                                        <div class="TableContentContainer">
                                            <table class="TableContent" width="100%" style="border:1px solid #faf0d7;">
                                                <tr>
                                                    <td><strong>Name:</strong></td>
                                                    <td><input size="29" type="text" name="name" class="search"></td>
                                                    <td>
                                                        <input type="Submit" value="Search" class="BigButton btn" style="background: url(layout/tibia_img/sbutton.gif); width:135px;height:25px;border: 0 none;" border="0">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
