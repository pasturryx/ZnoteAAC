...
if ($render_page) {
        ...
        <table style="width: auto;">
            <tr>
                <td style="background: transparent;">
                    <img src="layout/tibia_img/headline-bracer-left.gif">
                </td>
                <td style="background: transparent; text-align: center; vertical-align: middle; horizontal-align: center; font-size: 17px; font-weight: bold;">
                    Welcome to your account, <?php echo $user_data['name']; ?>!<br>
                </td>
                <td style="background: transparent;">
                    <img src="layout/tibia_img/headline-bracer-right.gif">
                </td>
            </tr>
        </table>
    </center>
    <center>
        <p>You have <?php echo $user_data['premium_days_remaining']; ?> days remaining premium account.</p>
    </center>
    <?php
    ...
    ?>
        <p>Account security with Two-factor Authentication: <a href="twofa.php"><?php echo ($status) ? 'Enabled' : 'Disabled'; ?></a></p>
    <?php
    }
														...
														<form action="https://secure.tibia.com/account/?subtopic=accountmanagement&amp;page=createcharacter" method="post" style="padding:0px;margin:0px;">
															<input type="hidden" name="selectedcharacter" value="Aerohe">
																<a href="createcharacter.php">
																	<div class="BigButton btn" style="margin: 0 5px;float: right;background-image:url(layout/tibia_img/button_green.gif)">
																			Create Character
																	</div>
																</a>
										...
										<tr>
											...
											<td id="submit_form">
												<?php
													...
													Token::create();
												?>
												<!-- <input id="submit_button" type="submit" value="Submit" class="btn btn-primary btn-block"></input> --agregado abajo esta editado-->
												<input name="submit" style="margin: 0 5px;display: inline-block;" class="BigButton btn" value="Submit" type="submit" >
											</td>
										</tr>
