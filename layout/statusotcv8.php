...
try {
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL, "https://forgottennot.online/");
...
$online_discord = 0;
try {
    $online_discord = json_decode(file_get_contents("https://discord.com/api/guilds/1068695350719807568/widget.json"))->presence_count;
} catch(Exception $e) {}
