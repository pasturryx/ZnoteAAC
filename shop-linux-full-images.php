			...
			<tr class="special">
				...
				<td>
					<form action="" method="POST">
						...
						<input type="submit" value="  PURCHASE  " div class="BigButton btn" style="margin: 0 5px;display: inline-block;background-image:url(layout/tibia_img/sbutton.gif)" data-item-name="<?php echo $offers['description']; ?>" data-item-cost="<?php echo $offers['points']; ?>">
					</form>
				</td>
				<?php endif; ?>
			</tr>
